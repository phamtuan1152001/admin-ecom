...
function NotificationChild({ isLoading = false, data, onSubmit = () => { }, onReadAllNoti = () => { } }) {
  // console.log("data", data)

  return (
    <>
      <div className='flex flex-row justify-end items-center mb-2 px-4'>
        <h1 className='text-base font-normal cursor-pointer hover:underline hover:underline-offset-4' onClick={() => onReadAllNoti()}>Read all</h1>
      </div>
